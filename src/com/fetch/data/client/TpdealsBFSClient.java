...
/**
 * Tpdeals businesses-for-sale
 * @author 
 *
 */
public class TpdealsBFSClient extends TpdealsClient{
	...
	private final static String webSite = "/businesses-for-sale/?page=";
	...
	public void fetchData() throws Exception{
		try {
			...
			log.error("获取Tpdeals businesses-for-sale网站报错："+e.getMessage(), e);
			throw e;
		}
	}
