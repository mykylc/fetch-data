...
/**
 * Turnerbutler Manufacturing
 * @author 
 *
 */
public class TurnerbutlerManufacturingClient extends TurnerbutlerClient{
	...
	private final static String webSite = "businessesforsalelistingsector.php?keyword=Manufacturing%20and%20Engineering&id=";
	...
	public void fetchData() throws Exception{
		try {
			...
			log.error("获取TurnerbutlerManufacturing网站报错："+e.getMessage(), e);
			throw e;
		}
	}
