...
/**
 * Turnerbutler Transport
 * @author 
 *
 */
public class TurnerbutlerTransportClient extends TurnerbutlerClient{
	...
	private final static String webSite = "businessesforsalelistingsector.php?keyword=Transport%20and%20Construction&id=";
	...
	public void fetchData() throws Exception{
		try {
			...
			log.error("获取TurnerbutlerTransport网站报错："+e.getMessage(), e);
			throw e;
		}
	}
	...
	public String getIndustry() {
		return "Transport and Construction";
	}
