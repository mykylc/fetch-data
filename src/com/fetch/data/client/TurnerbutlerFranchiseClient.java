...
/**
 * Turnerbutler Franchise
 * @author 
 *
 */
public class TurnerbutlerFranchiseClient extends TurnerbutlerClient{
	...
	private final static String webSite = "businessesforsalelistingsector.php?keyword=Franchise&id=";
	...
	public void fetchData() throws Exception{
		try {
			...
			log.error("获取TurnerbutlerFranchise网站报错："+e.getMessage(), e);
			throw e;
		}
	}
