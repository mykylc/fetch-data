...
/**
 * Turnerbutler Services
 * @author 
 *
 */
public class TurnerbutlerServicesClient extends TurnerbutlerClient{
	...
	private final static String webSite = "businessesforsalelistingsector.php?keyword=Services%20and%20Properties&id=";
	...
	public void fetchData() throws Exception{
		try {
			...
			log.error("获取TurnerbutlerServices网站报错："+e.getMessage(), e);
			throw e;
		}
	}
	...
	public String getIndustry() {
		return "Services and Properties";
	}
