...
public class FetchDataDao {
	...
	private static final String insert_sql = "INSERT into `Smile_2` (`name`, country, state, city, location, price, industry, description, project_type, company_type, "
			...
			+ "turnover, net_profit, gross_profit, EBITDA, asset, potential, advantage, financial_information, page_url, hash_code, inserting_time) "
			+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,"
			+ "?, ?, ?, ?, ?, ?, ?,   ?, ?, ?, ?, ?, ?, ?, ?,"
			+ "NOW());";
