 ...
 *
 */
public class TurnerbutlerITClient extends TurnerbutlerClient{
	...
	private final static String webSite = "businessesforsalelistingsector.php?keyword=IT&id=";
	...
	public void fetchData() throws Exception{
		try {
			...
			log.error("获取TurnerbutlerIT网站报错："+e.getMessage(), e);
			throw e;
		}
	}
	...
	public String getIndustry() {
		return "IT & E-commerce Businesses";
	}
}
