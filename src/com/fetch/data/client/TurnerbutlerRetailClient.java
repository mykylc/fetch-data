 ...
 *
 */
public class TurnerbutlerRetailClient extends TurnerbutlerClient{
	...
	private final static String webSite = "businessesforsalelistingsector.php?keyword=Retail%20and%20Consumer&id=";
	...
	public void fetchData() throws Exception{
		try {
			...
			log.error("获取TurnerbutlerRetail网站报错："+e.getMessage(), e);
			throw e;
		}
	}
